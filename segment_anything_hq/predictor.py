...
class SamPredictor:
    ...
    def predict_semantic_priors(self, img_size=None):
        #dino_feats: B,H,W,C
    ...
    def predict_torch(
        ...
        # Predict masks
        low_res_masks, iou_predictions, class_scores = self.model.mask_decoder(
        ...
        return masks, iou_predictions,  class_scores, low_res_masks
