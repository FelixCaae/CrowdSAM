...
annot_file="datasets/coco_split/instances_minival.json" #
# annot_file="datasets/coco/annotations/instances_val2017.json"
# annot_file="train_visible.json"  # "train_visible" #
exec_file="test.py"
options="--label_file $annot_file  --mask_selection max_area  --ref_feature_path template_features/ref_feature_50.pkl  --num_prompts 400 --box_nms_thresh 0.6 --pred_iou_thresh 0.1 --min_mask_region_area 100 --crop_n_layers 0 --dataset coco" 
