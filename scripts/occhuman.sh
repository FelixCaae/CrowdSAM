...
annot_file="ochuman_coco_format_val_range_0.75_1.00.json"
# odgt_file="annotation_val.odgt"
# annot_file="train_visible.json"  # "train_visible" #
exec_file="test.py"
options="--label_file $annot_file  --mask_selection max_area  --ref_feature_path template_features/ref_feature_50.pkl  --num_prompts 400 --crop_n_layers 0 --box_nms_thresh 0.65 --pred_iou_thresh 0.2 --min_mask_region_area 100 --crop_n_layers 0 --dataset occhuman" 
# options="$options --sam_model vit_l --sam_adapter_checkpoint ./sam_adapter_weights/10_shot.pth  --mask_selection max_iou" # 
options="$options --sam_model adaptvit_l --sam_adapter_checkpoint ./sam_adapter_weights/10_shot.pth  --mask_selection max_iou" # --apply_box_offsets
