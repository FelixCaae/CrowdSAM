...
options="--label_file $annot_file  --dataset crowdhuman --mask_selection max_area  --ref_feature_path template_features/ref_feature_50.pkl  --num_prompts 400 --crop_n_layers 0 --box_nms_thresh 0.65 --pred_iou_thresh 0.2 --min_mask_region_area 100 --crop_n_layers 0" 
# options="$options --sam_model vit_l --sam_adapter_checkpoint ./sam_adapter_weights/10_shot.pth  --mask_selection max_iou" # 
options="$options --sam_model hqvit_l --sam_adapter_checkpoint ./sam_adapter_weights/hq_sam_10_shot.pth  --mask_selection max_iou" # --sam_checkpoint segment_anything_hq/sam_hq_vit_l.pth" # --apply_box_offsets
