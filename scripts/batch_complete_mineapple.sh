...
annot_file="mineapple_test.json"
...
options="--label_file $annot_file  --select_biggest_mask  --ref_feature_path ref_feature_10_apple.pkl  --num_prompts 10 50 100 400 --score_thresh -1 --neg_sim_thresh 0  --pos_sim_thresh 0.3  --max_size 1024 --iou_thresh 0.5 --ref_feature_fusion mean --dataset datasets/mineapple/test_data/segmentation"
...
python tools/mineapple_coco_eval.py final.json 
